...
// XerialJ
//
// SilkWarningToken.java
// Since: 2011/06/08 17:23:10
//
// $URL$
// $Author$
//--------------------------------------
...
import xerial.silk.util.UTF8String;

public class SilkWarnToken extends SilkTextToken
{
    public final String errorMessage;

    public SilkWarnToken(int posInLine, UTF8String lineText, String errorMessage) {
