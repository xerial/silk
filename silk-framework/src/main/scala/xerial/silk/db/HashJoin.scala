...
object HashJoin extends Logger {
  ...
  def apply[A, B](a:SilkSeq[A], b:SilkSeq[B], aProbe: A=>Int, bProbe:B=>Int)(implicit weaver:Weaver) : SilkSeq[(A, B)] = {
...
object GroupBy {
  ...
  def apply[A, K](a:SilkSeq[A], aProbe: A => K)(implicit weaver:Weaver) : SilkSeq[(K, SilkSeq[A])] = {
...
object Sort {
  ...
  def apply[A, K](a:SilkSeq[A], ordering: Ordering[A], partitioner:RangePartitioner[A])(implicit weaver:Weaver) : SilkSeq[A] = {
